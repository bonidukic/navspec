...
def test_imports():
    ...
    try:
        from navspec.types import DashboardConfig, Category, Link, DashboardMetadata
...
def test_yaml_parsing():
    ...
    try:
        ...
        dev_category = next((cat for cat in config.categories if cat.name == "Development"), None)
        if dev_category:
