...
class Link:
    ...
    def __init__(self, name: str, url: str, description: str, tags: List[str], 
                 status: str = "active", icon: Optional[str] = None):
        self.name = name
        self.url = url
        self.description = description
        self.tags = tags
...
class Category:
    ...
    def __init__(self, name: str, description: str, links: List[Link], icon: Optional[str] = None):
        self.name = name
        self.description = description
        self.icon = icon
        self.links = links
...
class UserPreferences:
    ...
    def __init__(self, active_config: str = "default.yaml", theme: str = "light", 
                 layout: str = "grid", show_descriptions: bool = True, 
                 show_status: bool = True, custom_order: List[str] = None, 
...
class UserConfig:
    ...
    def __init__(self, config_path: str, preferences: UserPreferences, available_configs: List[str]):
...
class ServerOptions:
    ...
    def __init__(self, port: int = 7777, host: str = "127.0.0.1", 
                 config_path: str = ".", watch: bool = True, reload: bool = True):
        self.port = port
        self.host = host
        self.config_path = config_path
        self.watch = watch
